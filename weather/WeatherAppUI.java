...
public class WeatherAppUI extends JFrame {
    ...
    private String getIconNameFromText(String text) {
        if (text == null) return "default.png";
        String lower = text.toLowerCase();

        if (lower.contains("đêm") || lower.contains("night")) return "night.png";
        if (lower.contains("mưa") || lower.contains("rain")) return "rain.png";
        if (lower.contains("bão") || lower.contains("storm") || lower.contains("thunder")) return "storm.png";
        if (lower.contains("tuyết") || lower.contains("snow")) return "snow.png";
        if (lower.contains("mây") || lower.contains("cloud")) return "cloud.png";
        if (lower.contains("nắng") || lower.contains("sunny") || lower.contains("clear")) return "sunny.png";
        return "default.png";
    }
